...
namespace UnityThreading
{
    ...
    public class Dispatcher : DispatcherBase
    {
		...
		/// <summary>
		/// Returns the task which is currently being processed. 
        /// Use this only inside a task operation.
		/// </summary>
        ...
        /// When no instance has been created an exception will be thrown.
		/// </summary>
        /// 
		...
		/// <summary>
		/// Returns the first created Dispatcher instance, in most cases this will 
        /// be the Dispatcher for the main thread. When no instance has been created 
            ...
            get
            {
				if (mainDispatcher == null)
					throw new InvalidOperationException(
                        "No Dispatcher found for the main thread, " +
                        "please create a new Dispatcher instance before calling this property.");
		...
		/// <summary>
		/// Creates a new function based upon an other function which will 
        /// handle exceptions. Use this to wrap safe functions for tasks.
		/// </summary>
		...
		/// <summary>
        /// Creates a new action based upon an other action which will handle exceptions.
        /// Use this to wrap safe action for tasks.
		/// </summary>
		...
		/// <summary>
		/// Creates a Dispatcher, if a Dispatcher has been created in the 
        /// current thread an exception will be thrown.
		/// </summary>
		public Dispatcher()
			: this(true)
		{
        ...
        /// <summary>
        /// Creates a Dispatcher, if a Dispatcher has been created when setThreadDefaults 
        /// is set to true in the current thread an exception will be thrown.
        /// </summary>
        /// <param name="setThreadDefaults">If set to true the new dispatcher will be 
        /// set as threads default dispatcher.</param>
		...
		/// <summary>
		/// Processes all remaining tasks. Call this periodically to allow the 
        /// Dispatcher to handle dispatched tasks.
		...
		/// <summary>
		/// Processes all remaining tasks and returns true when something has 
        /// been processed and false otherwise.
		/// This method will block until the exitHandle has been set or tasks should be processed.
        /// Only call this inside the thread you want the tasks to process to be processed.
		/// </summary>
		...
		/// <summary>
		/// Processes the next available tasks and returns true when it has 
        /// been processed and false otherwise.
		/// This method will block until the exitHandle has been set or a task should be processed.
        /// Only call this inside the thread you want the tasks to process to be processed.
		/// </summary>
		/// <param name="exitHandle">The handle to indicate an early abort of the wait process.</param>
		/// <returns>False when the exitHandle has been set, true otherwise.</returns>
