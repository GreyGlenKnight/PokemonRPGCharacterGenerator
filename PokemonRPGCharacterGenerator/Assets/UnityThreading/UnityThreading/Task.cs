...
namespace UnityThreading
{
    ...
    public abstract class Task
    {
        ...
        /// <summary>
        /// Change this when you work with a prioritzable Dispatcher or TaskDistributor 
        ...
        /// If a Task should abort and has not yet been started
		...
		/// <summary>
		/// Returns true when processing of this task has been ended 
        /// or has been skipped due early abortion.
		/// </summary>
		...
		/// <summary>
		/// Returns true when the task has successfully been processed. 
        /// Tasks which throw exceptions will
		/// not be set to a failed state, also any exceptions will not be catched, 
        /// the user needs to add checks for these kind of situation.
		/// </summary>
		...
		/// <summary>
		/// Returns true if the task should abort and has been ended. 
        /// This value will not been set to true
		/// in case of an exception while processing this task. 
        /// The user needs to add checks for these kind of situation.
		/// </summary>
		...
		/// <summary>
		/// Notifies the task to abort and sets the task state to failed. 
        /// The task needs to check ShouldAbort if the task should abort.
		/// </summary>
        public void Abort()
        {
			abortEvent.Set();
		...
		/// Notifies the task to abort and sets the task state to failed. 
        /// The task needs to check ShouldAbort if the task should abort.
		/// This method will wait until the task has been aborted/ended or
		...
		/// <summary>
		/// Blocks the calling thread until the task has been ended or 
        /// the given timeout value has been reached.
		/// </summary>
		/// <param name="seconds">Time in seconds this method will max wait.</param>
		...
		/// <summary>
		/// Blocks the calling thread until the task has been ended and 
        /// returns the return value of the task as the given type.
		...
		/// <summary>
		/// Blocks the calling thread until the task has been ended and returns 
		...
		/// </summary>
		/// <param name="seconds">Time in seconds this method will max wait.</param>
		/// <param name="defaultReturnValue">The default return value which will 
        /// be returned when the task has failed.</param>
		/// <returns>The return value of the task as the given type.</returns>
