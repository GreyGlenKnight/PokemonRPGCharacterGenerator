...
//	}
	...
	{
		Pokemon TestMon = new Pokemon ();
        UnityEngine.Debug.Assert (TestMon._StatBlock.Attack.RawValue == 0);
	}
	...
	{
		Pokemon TestMon = new Pokemon ();
		UnityEngine.Debug.Assert (TestMon._StatBlock.Defense.RawValue == 0);
	}
	...
	{
		Pokemon TestMon = new Pokemon ();
		UnityEngine.Debug.Assert (TestMon._StatBlock.SpecialAttack.RawValue == 0);
	}
	...
	{
		Pokemon TestMon = new Pokemon ();
		UnityEngine.Debug.Assert (TestMon._StatBlock.SpecialDefense.RawValue == 0);
	}
	...
	{
		Pokemon TestMon = new Pokemon ();
		UnityEngine.Debug.Assert (TestMon._StatBlock.Speed.RawValue == 0);
	}
